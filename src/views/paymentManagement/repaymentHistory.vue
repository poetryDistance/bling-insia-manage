<template>
  <div class="main-box">
    ...
    <el-form ref="listQueryForm" :model="listQuery" size="mini" label-width="auto" inline>
      ...
      <el-form-item prop="repayWay" :label="$t('collect.collect226') + ': '"> <!-- 还款途径 -->
        <el-select
          v-model="listQuery.repayWay"
          filterable
          clearable
          :placeholder="$t('collect.collect227')"
        > <!-- 请选择还款途径 -->
          <el-option
    ...
    >
      ...
      <!-- 催收公司 -->
      <el-table-column v-if="permission.isAdmin" :label="$t('sysManage.sysManage57')" prop="companyName" align="center" min-width="70px" />
      <el-table-column v-if="permission.isAdmin || permission.isCollectionLead" :label="$t('collector.collector11')" prop="groupName" align="center" min-width="70px" /> <!-- 催收组 -->
      <el-table-column v-if="permission.isAdmin || permission.isCollectionLead || permission.isGroupLead" :label="$t('collect.collect13')" prop="loginName" align="center" min-width="70px" /> <!-- 催收员 -->
