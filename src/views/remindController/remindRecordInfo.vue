<template>
  <div class="main-box">
    ...
    >
      ...
      <el-table-column :label="$t('collect.collect53')" prop="relation" align="center" min-width="70px"> <!-- 联系人与债主的关系 -->
      ...
      <el-table-column :label="$t('loanMarket.loanMarket60')" prop="relationName" align="center" min-width="120px" /> <!-- 联系人名称 -->
      <el-table-column
        v-if="permission.isAdmin"
        key="companyName"
      ...
      <el-table-column
        ...
        min-width="80px"
      /> <!-- 催收员 -->
      <el-table-column :label="$t('collect.collect103')" prop="entryTime" align="center" min-width="140px"> <!-- 催收时间 -->
        <template slot-scope="{ row }">
      ...
      <el-table-column :label="$t('loanMarket.loanMarket71')" sortable prop="distanceRepayEndDay" align="center" min-width="80px" /> <!-- 到期天数 -->
