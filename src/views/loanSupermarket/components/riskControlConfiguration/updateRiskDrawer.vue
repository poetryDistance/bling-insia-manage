      ...
      <div style="height: 100vh">
        <el-scrollbar wrap-class="scrollbar-wrapper">
          ...
          >
            ...
            <el-form-item prop="usingModel" :label="$t('sysManage.sysManage92') + ': '"> <!-- 模型类型 -->
              <el-select
                v-model="updateForm.usingModel"
                filterable
                clearable
                style="width: 100%;"
...
export default {
  ...
  computed: {
    ...
    updateRules() {
      ...
      return {
        usingModel: [{ required: true, message: this.$t('borrow.borrow12'), trigger: 'change' }], /* 请选择模型类型 */
  ...
  mounted() {
    ...
    if (this.currentRow.usingModel) this.updateForm.usingModel = this.currentRow.usingModel
