      ...
      <div style="height: 100vh">
        <el-scrollbar wrap-class="scrollbar-wrapper">
          <el-form
            ...
            label-width="160px"
          >
            <el-form-item prop="marketName" :label="$t('loanMarket.loanMarket1') + ': '"> <!-- 贷超名称 -->
              <el-input v-model="updateForm.marketName" :placeholder="$t('loanMarket.loanMarket2')" /> <!-- 请输入贷超名称 -->
            </el-form-item>
            <el-form-item prop="marketPhone" :label="$t('loanMarket.loanMarket4') + ': '"> <!-- 贷超电话 -->
              <el-input v-model="updateForm.marketPhone" :placeholder="$t('loanMarket.loanMarket5')" /> <!-- 请输入贷超电话 -->
            </el-form-item>
            <el-form-item prop="contactsName" :label="$t('loanMarket.loanMarket16') + ': '"> <!-- 贷超联系人名称 -->
              <el-input v-model="updateForm.contactsName" :placeholder="$t('loanMarket.loanMarket21')" /> <!-- 请输入联系人名称 -->
            </el-form-item>
            <el-form-item prop="contactsMobile" :label="$t('loanMarket.loanMarket17') + ': '"> <!-- 贷超联系人手机 -->
              <el-input v-model="updateForm.contactsMobile" :placeholder="$t('loanMarket.loanMarket22')" /> <!-- 请输入联系人手机 -->
            </el-form-item>
            <el-form-item prop="givenId" :label="$t('loanMarket.loanMarket18') + ': '"> <!-- 贷超分配给我方的唯一ID -->
              <el-input v-model="updateForm.givenId" :placeholder="$t('loanMarket.loanMarket23')" /> <!-- 请输入唯一ID -->
            </el-form-item>
            <el-form-item prop="marketType" :label="$t('loanMarket.loanMarket8') + ': '"> <!-- 贷超类型 -->
              <el-select
            ...
            <el-form-item prop="marketAddress" :label="$t('loanMarket.loanMarket20') + ': '"> <!-- 贷超地址 -->
              <el-input v-model="updateForm.marketAddress" :placeholder="$t('loanMarket.loanMarket24')" /> <!-- 请输入贷超地址 -->
            </el-form-item>
...
export default {
  ...
  computed: {
    ...
    updateRules() {
      return {
        marketName: [{ required: true, message: this.$t('loanMarket.loanMarket2'), trigger: 'blur' }], /* 请输入贷超名称 */
        marketPhone: [{ required: true, message: this.$t('loanMarket.loanMarket5'), trigger: 'blur' }], /* 请输入贷超电话 */
        ...
        marketType: [{ required: true, message: this.$t('loanMarket.loanMarket9'), trigger: 'change' }], /* 请选择贷超类型 */
        marketAddress: [{ required: true, message: this.$t('loanMarket.loanMarket24'), trigger: 'blur' }] /* 请输入贷超地址 */
      }
    }
  },
