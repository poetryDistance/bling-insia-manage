        ...
        <el-scrollbar wrap-class="scrollbar-wrapper">
          ...
          >
            <el-form-item prop="marketName" :label="$t('loanMarket.loanMarket1') + ': '"> <!-- 贷超名称 -->
              <el-input v-model="addForm.marketName" :placeholder="$t('loanMarket.loanMarket2')" /> <!-- 请输入贷超名称 -->
            </el-form-item>
            <el-form-item prop="marketPhone" :label="$t('loanMarket.loanMarket4') + ': '"> <!-- 贷超电话 -->
              <el-input v-model="addForm.marketPhone" :placeholder="$t('loanMarket.loanMarket5')" /> <!-- 请输入贷超电话 -->
            </el-form-item>
            ...
            <el-form-item prop="marketAddress" :label="$t('loanMarket.loanMarket20') + ': '"> <!-- 贷超地址 -->
              <el-input v-model="addForm.marketAddress" :placeholder="$t('loanMarket.loanMarket24')" /> <!-- 请输入贷超地址 -->
            </el-form-item>
