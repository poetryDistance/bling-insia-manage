<template>
  <div class="main-box">
    ...
    <el-form ref="listQueryForm" :model="listQuery" size="mini" label-width="auto" inline>
      <el-form-item :label="$t('loanMarket.loanMarket1') + ': '"> <!-- 贷超名称 -->
        <el-input v-model="listQuery.marketName" :placeholder="$t('loanMarket.loanMarket2')" style="width: 178px;" /> <!-- 请输入贷超名称 -->
      </el-form-item>
      <el-form-item :label="$t('loanMarket.loanMarket4') + ': '"> <!-- 贷超电话 -->
        <el-input v-model="listQuery.marketPhone" :placeholder="$t('loanMarket.loanMarket5')" style="width: 178px;" /> <!-- 请输入贷超电话 -->
      </el-form-item>
      <el-form-item :label="$t('loanMarket.loanMarket6') + ':'"> <!-- 贷超状态 -->
        <!-- 请选择贷超状态 -->
        <el-select
      ...
      <el-form-item :label="$t('loanMarket.loanMarket8') + ': '"> <!-- 贷超类型 -->
        <el-select v-model="listQuery.marketType" filterable clearable :placeholder="$t('loanMarket.loanMarket9')"> <!-- 请选择贷超类型 -->
          <el-option
      ...
      <el-form-item label=" ">
        ...
        <el-button type="primary" @click="openAdd">{{ $t('loanMarket.loanMarket13') }}</el-button> <!-- 添加贷超 -->
      </el-form-item>
    </el-form>
    ...
    >
      ...
      <el-table-column :label="$t('loanMarket.loanMarket1')" prop="marketName" align="center" min-width="80px" /> <!-- 贷超名称 -->
      <el-table-column :label="$t('loanMarket.loanMarket15')" prop="marketPhone" align="center" min-width="90px" /> <!-- 贷超电话 -->
      <el-table-column :label="$t('loanMarket.loanMarket16')" prop="contactsName" align="center" min-width="90px" /> <!-- 贷超联系人名称 -->
      <el-table-column :label="$t('loanMarket.loanMarket17')" prop="contactsMobile" align="center" min-width="90px" /> <!-- 贷超联系人手机 -->
      <el-table-column :label="$t('loanMarket.loanMarket8')" prop="marketType" align="center" min-width="90px"> <!-- 贷超类型 -->
        <template slot-scope="{ row }">
          {{ row.marketType | marketTypeFilter }}
        </template>
      </el-table-column>
      <el-table-column :label="$t('loanMarket.loanMarket18')" prop="givenId" align="center" min-width="90px" /> <!-- 贷超分配给我方的唯一ID -->
      <el-table-column :label="$t('loanMarket.loanMarket20')" prop="marketAddress" align="center" min-width="90px" /> <!-- 贷超地址 -->
      ...
      <el-table-column :label="$t('loanMarket.loanMarket6')" prop="marketStatus" align="center" min-width="80px"> <!-- 贷超状态 -->
        <template slot-scope="{ row }">
