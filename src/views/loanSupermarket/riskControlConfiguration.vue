<template>
  <div class="main-box">
    ...
    >
      ...
      <el-table-column :label="$t('sysManage.sysManage92')" prop="usingModel" align="center" min-width="90px"> <!-- 模型类型 -->
        <template slot-scope="{ row }">
          {{ row.usingModel | modelTypeFilter }}
        </template>
      </el-table-column>
