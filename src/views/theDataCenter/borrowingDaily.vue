<template>
  <div class="main-box">
    <!-- 运营管理 -- 借款日报 -->
    <el-form ref="listQueryForm" :model="listQuery" size="mini" label-width="100px" inline>
    ...
    >
      ...
      <el-table-column :label="$t('borrow.borrow21')" min-width="100">    <!-- 老客 -->
        ...
        <el-table-column prop="oldApplyPass" :label="$t('theData.theData15')" />    <!-- 申请笔数 -->
        <el-table-column prop="oldApplyUser" :label="$t('theData.theData16')" />   <!-- 通过笔数 -->
