<template>
  <div class="main-box">
    ...
    >
      <el-table-column :label="$t('collect.collect210')" prop="id" align="center" min-width="70px" /> <!-- 借款编号 -->
      <el-table-column :label="$t('collect.collect3')" prop="userName" align="center" min-width="90px" /> <!-- 用户名 -->
      <el-table-column :label="$t('common.common28')" prop="companyPhone" align="center" min-width="90px" /> <!-- 手机号 -->
      <el-table-column :label="$t('collect.collect5')" prop="aadhaarNo" align="center" min-width="110px" /> <!-- 身份证号 -->
      <el-table-column
      ...
      <el-table-column
        ...
        min-width="80px"
      /> <!-- 催收员 -->
      <el-table-column :label="$t('collect.collect53')" prop="relation" align="center" min-width="90px"> <!-- 联系人与债主的关系 -->
      ...
      <el-table-column :label="$t('collect.collect45')" prop="commitmentAmount" align="center" min-width="80px" /> <!-- 承诺还款金额 -->
      ...
      <el-table-column :label="$t('collect.collect67')" prop="type" align="center" min-width="90px"> <!-- 类型 -->
        <template slot-scope="{ row }">
          {{ row.type | typeFilter }}
        </template>
      </el-table-column>
...
import { getCollectionRecord } from '@/api/collectionManagement'
