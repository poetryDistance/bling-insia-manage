      ...
      <div style="height: 100vh">
        <el-scrollbar wrap-class="scrollbar-wrapper">
          <el-form
            ...
            size="small"
          >
            <el-form-item prop="reviewStatus" :label="$t('loanMarket.loanMarket105') + ': '"> <!-- 是否通过 -->
              <el-select
                v-model="revisarForm.reviewStatus"
                filterable
                style="width: 100%;"
                :placeholder="$t('loanMarket.loanMarket106')"
              > <!-- 请选择是否通过 -->
                <el-option
            ...
            <el-form-item
              ...
              label=" "
            >
              <el-checkbox v-model="revisarForm.blackCustomer">{{ $t('loanMarket.loanMarket107') }}</el-checkbox> <!-- 加入黑名单 -->
            </el-form-item>
            <el-form-item label=" ">
...
export default {
  ...
  computed: {
    ...
    revisarRules() {
      return {
        reviewStatus: [
          { required: true, message: this.$t('loanMarket.loanMarket106'), trigger: 'change' } /* 请选择是否通过 */
        ]
      }
    }
  },
