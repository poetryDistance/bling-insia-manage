...
export default {
  ...
  computed: {
    ...
    relationOptions() {
      return [
        ...
        { value: 20, label: this.$t('collect.collect55') }, /* 父亲 */
        { value: 30, label: this.$t('collect.collect56') }, /* 母亲 */
        { value: 40, label: this.$t('collect.collect57') }, /* 儿子 */
        { value: 50, label: this.$t('collect.collect58') }, /* 女儿 */
        { value: 60, label: this.$t('collect.collect59') }, /* 兄弟 */
        { value: 70, label: this.$t('collect.collect60') }, /* 姐妹 */
  ...
  methods: {
    relationChange(e) {
      if (e === 80) {
        this.addForm.relationName = this.currentRow.companyName
