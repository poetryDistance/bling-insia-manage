<template>
  <div class="main-box">
    ...
    >
      ...
      <el-table-column :label="$t('collect.collect8')" sortable prop="overDueDays" align="center" min-width="80px" /> <!-- 逾期天数 -->
      <el-table-column :label="$t('loanMarket.loanMarket56')" prop="principal" align="center" min-width="80px" /> <!-- 实际还款金额 -->
