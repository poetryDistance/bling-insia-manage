<template>
  <div class="main-box">
    <!-- 催收管理 -- 线下还款订单 -->
    <el-form ref="listQueryForm" :model="listQuery" size="mini" label-width="80px" inline>
    ...
    >
      ...
      <el-table-column :label="$t('borrow.borrow1')" prop="aadhaarNo" align="center" min-width="100px" /> <!-- 身份证号 -->
      <el-table-column v-if="permission.isAdmin" :label="$t('sysManage.sysManage57')" prop="companyName" align="center" min-width="70px" /> <!-- 催收公司 -->
