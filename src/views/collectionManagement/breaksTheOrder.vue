<template>
  <div class="main-box">
    ...
    <el-form ref="listQueryForm" :model="listQuery" size="mini" label-width="auto" inline>
      ...
      <el-form-item prop="orderId" :label="$t('collect.collect2') + ':'"> <!-- 订单编号 -->
        <el-input v-model="listQuery.orderId" :placeholder="$t('collect.collect74')" style="width: 178px;" /> <!-- 请输入订单编号 -->
      </el-form-item>
    ...
    >
      ...
      <el-table-column :label="$t('collect.collect2')" prop="id" align="center" min-width="70px" /> <!-- 订单编号 -->
