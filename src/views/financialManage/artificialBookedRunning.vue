<template>
  <div class="main-box">
    ...
    <el-form ref="listQueryForm" :model="listQuery" size="mini" label-width="auto" inline>
      ...
      <el-form-item prop="borrowUid" :label="$t('financial.financial8') + ':'" label-width="80px"> <!-- Uid -->
    ...
    >
      ...
      <el-table-column :label="$t('collect.collect10')" min-width="150"> <!-- 待还本金 -->
      ...
      <el-table-column :label="$t('borrow.borrow52')" min-width="150"> <!-- 滞纳金 -->
        <template slot-scope="scope">
      ...
      <el-table-column :label="$t('borrow.borrow25')" min-width="150"> <!-- 利息 -->
        <template slot-scope="scope">
