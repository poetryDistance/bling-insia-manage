<template>
  <div class="main-box">
    ...
    >
      ...
      <el-table-column :label="$t('borrow.borrow14')" prop="customerName" align="center" min-width="80px" /> <!-- 客户名 -->
      <el-table-column :label="$t('common.common28')" prop="customerMobile" align="center" min-width="90px" /> <!-- 手机号 -->
      <el-table-column :label="$t('borrow.borrow1')" prop="aadhaarNo" align="center" min-width="110px" /> <!-- 身份证号 -->
      <el-table-column :label="$t('userManage.userManage5')" prop="customerSex" align="center" min-width="60px"> <!-- 性别 -->
        <template slot-scope="{ row }">
          {{ row.customerSex | userSexFilter }}
        </template>
      </el-table-column>
      <el-table-column :label="$t('userManage.userManage8')" prop="maritalStatus" align="center" min-width="80px"> <!-- 婚姻状况 -->
        <template slot-scope="{ row }">
      ...
      <el-table-column :label="$t('userManage.userManage1')" prop="applyingCustomer" align="center" min-width="110px"> <!-- 申请中的贷款 -->
        <template slot-scope="{ row }">
          {{ row.applyingCustomer | whetherFilter }}
        </template>
      </el-table-column>
      <el-table-column :label="$t('userManage.userManage7')" prop="loaningCustomer" align="center" min-width="100px"> <!-- 贷款中的贷款 -->
        <template slot-scope="{ row }">
          {{ row.loaningCustomer | whetherFilter }}
        </template>
      </el-table-column>
      <el-table-column :label="$t('userManage.userManage9')" prop="overdueCustomer" align="center" min-width="80px"> <!-- 逾期行为 -->
        <template slot-scope="{ row }">
          {{ row.overdueCustomer | whetherFilter }}
        </template>
      </el-table-column>
      <el-table-column :label="$t('userManage.userManage11')" prop="repaidCustomer" align="center" min-width="100px"> <!-- 已还款的贷款 -->
        <template slot-scope="{ row }">
