<template>
  <div class="main-box">
    ...
    <el-form ref="listQueryForm" :model="listQuery" size="mini" label-width="auto" inline>
      <el-form-item prop="content" :label="$t('risk.risk55') + ':'"> <!-- 选民卡号或手机号 -->
        <el-input v-model="listQuery.content" :placeholder="$t('risk.risk56')" style="width: 178px;" /> <!-- 请输入选民卡号或手机号 -->
      </el-form-item>
    ...
    >
      ...
      <el-table-column :label="$t('risk.risk55')" prop="content" align="center" min-width="180px" /> <!-- 手机号或选民卡号 -->
