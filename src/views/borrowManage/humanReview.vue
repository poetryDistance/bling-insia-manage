<template>
  <div class="main-box">
    ...
    >
      ...
      <el-table-column :label="$t('borrow.borrow1')" prop="aadhaarNo" align="center" min-width="140" /> <!-- 身份证号 -->
      <el-table-column :label="$t('collect.collect7')" prop="principalAmount" align="center" min-width="90px" /> <!-- 借款金额 -->
      <el-table-column :label="$t('loanMarket.loanMarket8')" prop="marketName" align="center" min-width="90px" /> <!-- 贷超类型 -->
