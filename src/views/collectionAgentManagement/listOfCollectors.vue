...
import addCollectorDrawer from './components/listOfCollectors/addCollectorDrawer.vue'
import updateCollectorDrawer from './components/listOfCollectors/updateCollectorDrawer.vue'
