 ...
 * 摩比黑名单配置 -- 获取
 */
export function getBlackConfigInfo(data) {
  return request({
    url: process.env.VUE_APP_BASE_API + '/user/getBlackConfigInfo',
    method: 'post',
    data
  })
}
 ...
 * 摩比黑名单配置 -- 添加
 */
export function addBlackConfig(data) {
  return request({
    url: process.env.VUE_APP_BASE_API + '/user/addBlackConfig',
    method: 'post',
    data
  })
}
 ...
 * 摩比黑名单配置 -- 修改
 */
export function updateBlackConfig(data) {
  return request({
    url: process.env.VUE_APP_BASE_API + '/user/updateBlackConfig',
    method: 'post',
    data
  })
}
 ...
 * 摩比黑名单配置 -- 删除
 */
export function delBlackConfig(data) {
  return request({
    url: process.env.VUE_APP_BASE_API + '/user/delBlackConfig',
    method: 'post',
    data
  })
}
