...
export function userSexFilter(userSex) {
  switch (userSex * 1) {
    ...
    case 30:
      return i18n.tc('common.common9') /* 变性人 */
    default:
      return ''
  }
}
...
export function modelTypeFilter(modelType) {
  switch (modelType * 1) {
    ...
    case 20:
      return 'zelda'
    case 30:
      return i18n.tc('common.common21') /* 内部 */
    case 40:
      return i18n.tc('common.common22') /* 基础 */
    case 50:
      return i18n.tc('theData.theData60') /* cash风控 */
    case 60:
      return i18n.tc('theData.theData61') /* 冒泡风控 */
    default:
      return ''
  }
}
 ...
 */
export function borrowStatusFilter(data) {
  switch (data * 1) {
    case 10:
      return i18n.tc('collect.collect24') /* 等待推送 */
    case 20:
      return i18n.tc('collect.collect25') /* 推送中 */
    case 30:
      return i18n.tc('collect.collect27') /* 试算中 */
    case 40:
      return i18n.tc('collect.collect28') /* 等待用户确认 */
    case 50:
      return i18n.tc('collect.collect26') /* 风控中 */
    case 51:
      return i18n.tc('theData.theData62') /* 人审中 */
    case 60:
...
export function relationFilter(relation) {
  switch (relation * 1) {
    ...
    case 20:
      return i18n.tc('collect.collect55') /* 父亲 */
    case 30:
      return i18n.tc('collect.collect56') /* 母亲 */
    case 40:
      return i18n.tc('collect.collect57') /* 儿子 */
    case 50:
      return i18n.tc('collect.collect58') /* 女儿 */
    case 60:
      return i18n.tc('collect.collect59') /* 兄弟 */
    case 70:
      return i18n.tc('collect.collect60') /* 姐妹 */
    case 80:
...
export function whetherFilter(whether) {
  switch (whether) {
    case true:
      return i18n.tc('common.common38') /* 存在 */
    case false:
      return i18n.tc('common.common39') /* 不存在 */
    default:
      return ''
  }
}
...
export function maritalStatusFilter(maritalStatus) {
  switch (maritalStatus * 1) {
    ...
    case 40:
      return i18n.tc('userManage.userManage15') /* 丧偶 */
    case 50:
      return i18n.tc('common.common6') /* 未知 */
    default:
      return ''
